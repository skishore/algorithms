// Test case that runs the Hungarian algorithm and verifies a known result.
// This binary will throw an assertion error if the algorithm is incorrect.
...
static const Cost kCostMatrix[15][15] = {
